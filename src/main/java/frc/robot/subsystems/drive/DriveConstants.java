...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 8.0;
  public static final double trackWidth = Units.inchesToMeters(23.0);

  // Device CAN IDs
  public static final int pigeonCanId = 9;
  public static final int leftLeaderCanId = 23;
  public static final int leftFollowerCanId = 4;
  public static final int rightLeaderCanId = 21;
  public static final int rightFollowerCanId = 22;

  // Motor configuration
  public static final int currentLimit = 60;
  public static final double wheelRadiusMeters = Units.inchesToMeters(5.5);
